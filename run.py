...
from cornavirus import application
...
app.mount(path='/static', app=StaticFiles(directory='./cornavirus/static'), name='static')  # .mount()不要在分路由APIRouter().mount()调用，模板会报错
...
app.include_router(application, prefix='/cornavirus', tags=['新冠病毒疫情跟踪器API'])
